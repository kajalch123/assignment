...
<option value="30000">fashion design</option>
<option value="40000">interior design</option>
<option value="20000">textile design</option>
</select>
</div>


<div class="frontform">
<input type="number" name="duration" id="duration" placeholder="duration" onblur=f1() /></div>
<div class="frontform"><input type="number name="ta" id="ta"
readonly="readonly" placeholder="total amount"/>
